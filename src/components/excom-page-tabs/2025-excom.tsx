...
export default function TwentyFiveExcom({ category }: Props) {
  ...
  return (
    <div className="mx-auto mb-10">
      <div className="flex flex-wrap flex-cols-1 justify-center md:flex-cols-3 container mx-auto max-w-[390px] md:max-w-[690px] lg:max-w-[850px] xl:max-w-[1100px] md:gap-5 pb-10">
        {excomCard}
      </div>
    </div>
  );
